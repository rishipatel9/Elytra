    ...
    await index.upsert([
      {
        ...
        metadata: {
          ...
          GeneralInformation: {
            Ranking: validatedData.ranking,
            University: validatedData.college,
            College: validatedData.college,
            Location: validatedData.location,
            PublicPrivate: validatedData.publicPrivate,
            SpecialLocationFeatures: validatedData.specialLocationFeatures,
    ...
    await index.upsert([
      {
        ...
        metadata: {
          ...
          Percentage: validatedData.eligibility.minimumGpa,
          Backlogs: validatedData.eligibility.backlogs,
          WorkExperience: validatedData.eligibility.workExperience,
          Allow3YearDegree: validatedData.eligibility.allow3YearDegree,
        },
      },
    ]);
